            ...
            <div class="col-md-12">
                <div class="invoice" id="invoice">
                    ...
                    <div class="row justify-content-between">
                        ...
                        <!-- Date on right -->
                        <div class="col-md-6" style="width: 50% !important;text-align: right">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-6" style="width: 50% !important;text-align: right">
                            <h6>Bill To:</h6>
                            @if($invoice->customer)
                                <p>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-sm-6 text-end" style="width: 50% !important;text-align: right">
                            <h6>@if($invoice->due_amount>0)Total Due: {{ number_format($invoice->due_amount, 2) }} {{ $website_info->currency }}@else Paid @endif</h6>
                        </div>
