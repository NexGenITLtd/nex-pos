...
<body>
    <div class="invoice" style="width: 58mm; box-sizing: border-box;font-size: 12px;" id="58mm">
    	<style>
        ...
        @media print {
            ...
            .invoice {
                width: 58mm; /* Ensure it fits the printer paper size */
            ...
            <tr>
                <td>
                    @if($invoice->customer)
                        ...
                        <p style="margin-bottom: 0;font-size: 12px">{{ $invoice->customer->name ?? 'CID: '.$invoice->customer->id }}</p>
    ...
    <table style="width: 100%; border-collapse: collapse;">
        ...
        <tbody>
            ...
            @if($invoice->returnSellProducts->isNotEmpty()) 
                <tr style="border-top: 1px solid #B2B2B2;border-bottom: 1px solid #B2B2B2;">
                    <td  colspan="4" style="font-size: 12px;text-align: center; ">{{ __('Returned Products') }}</td>
                </tr>
        ...
        <tfoot>
            <tr>
                <th colspan="3" style="font-size: 12px; text-align: right;border: 1px solid #B2B2B2;">Subtotal</th>
                <th style="font-size: 12px; text-align: right;border: 1px solid #B2B2B2;">{{ number_format($subtotal, 2) }}</th>
            </tr>
            <tr>
                <th colspan="3" style="font-size: 12px; text-align: right;border: 1px solid #B2B2B2;">Discount</th>
                <th style="font-size: 12px; text-align: right;border: 1px solid #B2B2B2;">-{{ number_format($invoiceDiscountAmount, 2) }}</th>
            </tr>
            <tr>
                <th colspan="3" style="font-size: 12px; text-align: right;border: 1px solid #B2B2B2;">Total VAT</th>
                <th style="font-size: 12px; text-align: right;border: 1px solid #B2B2B2;">{{ number_format($totalVat, 2) }}</th>
            </tr>
            <tr>
                <th colspan="3" style="font-size: 12px; text-align: right;border: 1px solid #B2B2B2;">Less</th>
                <th style="font-size: 12px; text-align: right;border: 1px solid #B2B2B2;">-{{ number_format($lessAmount, 2) }}</th>
            </tr>
            <tr>
                <th colspan="3" style="font-size: 12px; text-align: right;border: 1px solid #B2B2B2;">Total</th>
...
<div class="buttons no-print">
    <a href="#" class="btn btn-primary btn-sm" onclick="printDiv('58mm'); return false;">Print</a>
