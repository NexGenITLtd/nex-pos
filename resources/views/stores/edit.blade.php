    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Store Edit</li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-4 form-group">
                ...
                <input type="email" id="email" name="email" class="form-control" value="{{$store->email}}">
              </div>
              ...
              <div class="col-md-4 form-group">
                ...
                <textarea id="address" name="address" class="form-control" rows="4">{{$store->address}}</textarea>
              </div>
              <div class="col-md-4 form-group">
                <label for="return_policy">Return policy</label>
                <textarea id="return_policy" name="return_policy" class="form-control" rows="4">{{$store->return_policy}}</textarea>
              </div>
              <div class="col-md-4 form-group">
