      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h1 class="card-title">Create New Menu</h1>
            <div class="card-tools">
              <a href="{{route('menus.index')}}" class="btn btn-success float-right"><i class="fa fa-angle-double-left"></i> Back</a>
            </div>
          </div>
            <div class="card-body">
              <form action="{{ route('menus.store') }}" method="POST" class="row g-3 align-items-center">
                  @csrf
                  ...
                  <div class="col-auto">
                      ...
                      <input type="text" name="route" class="form-control" placeholder="Route" list="routeList" autocomplete="off">
                  ...
                  <div class="col-auto">
                      <button type="submit" class="btn btn-success mt-4">Create Menu</button>
                  </div>
              </form>
          </div>
