        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-tools">
            	<form method="GET" action="{{ route('sell-products.index') }}" class="form-inline">
                ...
                <a href="{{ route('sell-products.pdf', request()->all()) }}" class="btn btn-success ml-2 mb-2">Download PDF</a>
                </form>
